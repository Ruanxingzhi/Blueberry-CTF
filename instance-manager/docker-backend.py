...
port_start = int(os.getenv("INSTANCE_PORT_START", "25000"))
port_end = int(os.getenv("INSTANCE_PORT_END", "26000"))
if port_end <= port_start:
    raise ValueError("INSTANCE_PORT_END must be greater than INSTANCE_PORT_START")
avaliable_ports = list(range(port_start, port_end))
